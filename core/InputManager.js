...
class InputManager
{
   ...
   onKeyUp(event) {
    ...
    createParamsGUI()
    {
        ...
        if (_this.vehicle.app.selectedDemo === 'lane-change') {
          settingsFolder.add(this.params, 'lane1').onChange((enabled) => {
                _this.vehicle.currentLane = (_this.vehicle.currentLane === _this.vehicle.road.lane) ?
                _this.vehicle.road.lane2
                :
                _this.vehicle.road.lane;
            });
        }
