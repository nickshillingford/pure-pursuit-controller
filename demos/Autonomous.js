...
class AutonomousVehicle extends Object3D {
  constructor(app) {
    ...
    this.road = app.data;
    this.currentLane = this.road.lane;
  ...
  updatePurePursuit() {
    ...
    let perpendicularLine = calculatePerpendicularLine(pointA.clone(), pointD.clone(), this.currentLane, lookAheadDistance);
    ...
    try {
      if (this.inputManager.params.Debug_Steering) {
        ...
        this.forwardLine = new Line(geometry, new LineBasicMaterial({ color: 0x0000ff }));
        ...
        this.renderer.scene.remove(this.perpendicular);
      	...
      	this.perpendicular = new Line(geometry, new LineBasicMaterial({ color: 0x0000ff }));
        ...
        this.triangleSideBC = new Line(geometry, new LineBasicMaterial({ color: 0x0000ff }));
        ...
        this.triangleSideCA = new Line(geometry, new LineBasicMaterial({ color: 0x0000ff }));
